...
def test_env_var_methods():
    ...
    assert canoe_inst.start_measurement()
    wait(1)
    canoe_inst.set_environment_variable('int_var', 123.12)
    canoe_inst.get_environment_variable('int_var')
    canoe_inst.set_environment_variable('float_var', 111.123)
    canoe_inst.get_environment_variable('float_var')
    canoe_inst.set_environment_variable('string_var', 'this is string variable')
    canoe_inst.get_environment_variable('string_var')
    canoe_inst.set_environment_variable('data_var', (1, 2, 3, 4, 5, 6, 7))
    canoe_inst.get_environment_variable('data_var')
    wait(1)
    assert canoe_inst.stop_measurement()
